package com.hkr.architecture.tennis.notscan.thread;


import com.hkr.architecture.tennis.StringTool;
...
public class NamedThreadFactory implements ThreadFactory {
    ...
    public NamedThreadFactory(String prefix, ThreadGroup threadGroup, boolean isDeamon, UncaughtExceptionHandler handler) {
        this.prefix = StringTool.isEmpty(prefix) ? "Tennis-core" : prefix;
        if (null == threadGroup) {
            threadGroup = ThreadPoolTool.currentThreadGroup();
        }
