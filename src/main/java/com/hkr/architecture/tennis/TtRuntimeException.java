 ...
 */
public abstract class TtRuntimeException extends RuntimeException {
     ...
     * @param code
     */
    public TtRuntimeException(int code) {
        super();
        this.code = code;
    }
     ...
     * @param msg
     */
    public TtRuntimeException(String msg) {
        super(msg);
    }
     ...
     * @param description
     */
    public TtRuntimeException(int code, String description) {
        super(description);
        this.code = code;
     ...
     * @param description
     */
    public TtRuntimeException(int code, String description, String msg) {
        super(msg);
        this.code = code;
        this.description = description;
    }
     ...
     * @param cause
     */
    public TtRuntimeException(String msg, Throwable cause) {
        super(msg, cause);
    }
     ...
     * @param cause
     */
    public TtRuntimeException(int code, String description, Throwable cause) {
    ...
    public boolean contains(Class<?> exType) {
        ...
        if (cause instanceof TtRuntimeException) {
            return ((TtRuntimeException) cause).contains(exType);
        } else {
            while (cause != null) {
