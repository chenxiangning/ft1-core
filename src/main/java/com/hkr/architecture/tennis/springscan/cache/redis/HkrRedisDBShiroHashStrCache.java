...
import com.hkr.architecture.tennis.springscan.cache.HkrKeyHashCache;
 ...
 */
@Service
public class HkrRedisDBShiroHashStrCache implements HkrKeyHashCache {
    @Autowired
    @Qualifier(value = "strRedisTemplateShiro4")
