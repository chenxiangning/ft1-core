package com.hkr.architecture.tennis.springscan.guaua.aop;

import com.google.common.util.concurrent.RateLimiter;
import com.hkr.architecture.tennis.TennisToolException;
import com.hkr.architecture.tennis.notscan.guaua.RateLimiterMapTool;
...
public class ApiRateLimiterMapAspect {
    ...
    @Before("@annotation(com.hkr.architecture.tennis.springscan.guaua.annotation.ApiRateLimiterMap)")
