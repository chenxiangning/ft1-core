...
import static com.reachauto.hkr.tennis.ft1.notscan.date.TimeInterval.SECONDS_PER_HOUR;
import static com.reachauto.hkr.tennis.ft1.notscan.date.TimeInterval.SECONDS_PER_MINUTE;
...
public final class DateTool {
    ...
    public static int getNumberOfMinutesBetweenTheTwoTime(String before, String after) {
        long beforeTime = DateTool.toDate(before, DatePattern.DATE_PATTERNS).getTime();
        long afterTime = DateTool.toDate(after, DatePattern.DATE_PATTERNS).getTime();
