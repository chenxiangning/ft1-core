...
public class AESTool {
     ...
     * @since JDK 1.7
     */
    public static String encrypt(String clearText) throws HkrServerException {
        byte[] result;
        try {
            byte[] rawkey = getRawKey(KEY.getBytes());
            result = encrypt(rawkey, clearText.getBytes());
        } catch (Exception e) {
            throw new HkrServerException(e.getMessage(), e.getCause());
        }
     ...
     * @since JDK 1.7
     */
    public static String decrypt(String seed, String encrypted) throws HkrServerException {
        byte[] rawKey;
        try {
     ...
     * @since JDK 1.7
     */
    public static String decrypt(String encrypted) throws HkrServerException {
        byte[] rawKey;
        try {
