...
public class GlobalExceptionCode {
    ...
    public static final String SERVER_SIDE_DEFAULT_EXCEPTIONS_MSG = "业务处理抛异常了";

    /**
     * 业务调用第三方异常的默认应答码为5020
     */
    public static final int SERVER_SIDE_INVOKE_THREEPARTY_EXCEPTIONS = 5020;
    public static final String SERVER_SIDE_INVOKE_THREEPARTY_EXCEPTIONS_MSG = "业务调用第三方异常了";

    /**
     * BFF层服务异常的默认应答码为700
     */
    public static final int SERVER_BFF_DEFAULT_EXCEPTIONS = 700;
    public static final String SERVER_BFF_DEFAULT_EXCEPTIONS_MSG = "接口处理异常";

    /**
     * BFF层服务带有返回内容的异常的默认应答码为701
     */
    public static final int RESULT_BFF_DEFAULT_EXCEPTIONS = 701;
    public static final String RESULT_BFF_DEFAULT_EXCEPTIONS_MSG = "接口异常返回";
