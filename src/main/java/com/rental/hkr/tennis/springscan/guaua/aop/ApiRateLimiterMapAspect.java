package com.rental.hkr.tennis.springscan.guaua.aop;

import com.google.common.util.concurrent.RateLimiter;
import com.rental.hkr.tennis.TennisToolException;
import com.rental.hkr.tennis.notscan.guaua.RateLimiterMapTool;
...
public class ApiRateLimiterMapAspect {
    ...
    @Before("@annotation(com.rental.hkr.tennis.springscan.guaua.annotation.ApiRateLimiterMap)")
