...
import com.hkr.architecture.tennis.notscan.thread.ThreadPoolTool;
import com.hkr.architecture.tennis.springscan.guaua.annotation.ApiRateLimiterMap;
import com.hkr.architecture.tennis.springscan.handler.LoginContextTool;
...
public class DemoController {
    ...
    public String g() {
        ...
        demoService.getBean(1, 2, "3", new com.hkr.architecture.tennis.springscan.cache.DemoBean("22222"));
        return "";
    }
    ...
    @ResponseBody
    public String ec() {
        throw new TennisToolException(123, "啦啦");
    }
    ...
    public String ec2() {
        ...
        fixedThreadPool.execute(() -> {
            ...
            throw new TennisToolException(1122, "123asdasd");
        });
    ...
    @ResponseBody
    @ApiRateLimiterMap(key = "am:ll_find", qps = 1)
