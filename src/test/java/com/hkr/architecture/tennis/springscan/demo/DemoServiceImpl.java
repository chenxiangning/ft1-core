...
import com.hkr.architecture.tennis.springscan.cache.annotation.HkrCacheDel;
...
public class DemoServiceImpl {
    ...
    @HkrCache(model = "mn", expire = 33)
    public com.hkr.architecture.tennis.springscan.cache.DemoBean getBean(int a, Integer b, String c, com.hkr.architecture.tennis.springscan.cache.DemoBean d) {
        return new com.hkr.architecture.tennis.springscan.cache.DemoBean("陈湘宁1");
