...
import com.rental.hkr.tennis.notscan.thread.ThreadPoolTool;
import com.rental.hkr.tennis.springscan.guaua.annotation.ApiRateLimiterMap;
import com.rental.hkr.tennis.springscan.handler.LoginContextTool;
...
public class DemoController {
    ...
    public String g() {
        ...
        demoService.getBean(1, 2, "3", new com.rental.hkr.tennis.springscan.cache.DemoBean("22222"));
        return "";
    }
