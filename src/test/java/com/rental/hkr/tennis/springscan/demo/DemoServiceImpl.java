...
public class DemoServiceImpl {
    ...
    @HkrCache(model = "mn", expire = 33)
    public com.rental.hkr.tennis.springscan.cache.DemoBean getBean(int a, Integer b, String c, com.rental.hkr.tennis.springscan.cache.DemoBean d) {
        return new com.rental.hkr.tennis.springscan.cache.DemoBean("陈湘宁1");
