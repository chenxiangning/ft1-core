...
import com.reachauto.hkr.tennis.springscan.cache.annotation.HkrCacheDel;
...
public class DemoServiceImpl {
    ...
    @HkrCache(model = "mn", expire = 33)
    public com.reachauto.hkr.tennis.springscan.cache.DemoBean getBean(int a, Integer b, String c, com.reachauto.hkr.tennis.springscan.cache.DemoBean d) {
        return new com.reachauto.hkr.tennis.springscan.cache.DemoBean("陈湘宁1");
